...
dataset_path = r"C:\Users\Dell\Desktop\DESKTOP_FOLDER\FINAL YEAR PROJECT\qryptify\datasets\padded_traintest_dataset.csv"
train_path = r"C:\Users\Dell\Desktop\DESKTOP_FOLDER\FINAL YEAR PROJECT\qryptify\datasets\ptrain_newdataset.csv"
...
algorithm_mapping = [
    ...
    (encrypt_caesar, "Classical", "Substitution", "Caesar"),

    # Hybrid algorithms
    (encrypt_rsa_oaep_aes, "Hybrid", "Asymmetric + Symmetric", "Hybrid-RSA-OAEP-AES"),
    (encrypt_ecies_aes, "Hybrid", "Asymmetric + Symmetric", "Hybrid-ECIES-AES"),
    (encrypt_pgp_armored, "Hybrid", "Asymmetric + Symmetric", "PGP-Armored"),
    (encrypt_tls_like_ecdhe, "Hybrid", "Asymmetric + Symmetric", "TLS-ECDHE-AES"),

    # Post-Quantum algorithms
    (encrypt_kyber_aes, "Post-Quantum", "Lattice + Symmetric", "Kyber-AES"),
    (encrypt_frodokem_aes, "Post-Quantum", "Lattice + Symmetric", "FrodoKEM-AES"),
    (encrypt_ntru_aes, "Post-Quantum", "Lattice + Symmetric", "NTRU-AES")
]
