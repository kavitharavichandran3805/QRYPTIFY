...
export default function LoginSection({ onSuccess }) {
  ...
  const [isForgotPassword, setIsForgotPassword] = useState(false); // 👈 new
  ...
  const [formData, setFormData] = useState({
    ...
    email: '',
    password: '',
    confirmPassword: '', // 👈 new for signup/forgot
  });
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                {!isForgotPassword && (
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      type="button"
                      onClick={() => setIsForgotPassword(true)} // 👈 toggle
                ...
                >
                  {isForgotPassword ? 'Set Password' : isSignUp ? 'Sign Up' : 'Sign In'}
